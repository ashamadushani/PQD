...
const string GET_COMPONENT_OF_AREA="SELECT pqd_component_id,pqd_component_name,pqd_product_id,sonar_project_key FROM pqd_component WHERE pqd_area_id=?";

const string GET_COMPONENT_OF_PRODUCT="SELECT pqd_component_id,pqd_component_name,pqd_product_id,sonar_project_key FROM pqd_component WHERE pqd_product_id=?";

const string GET_DETAILS_OF_COMPONENT = "SELECT pqd_component_id,pqd_component_name,pqd_product_id,sonar_project_key FROM pqd_component WHERE pqd_component_id=?";
