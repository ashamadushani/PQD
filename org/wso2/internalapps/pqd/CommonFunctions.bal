...
function getSQLConnectorForIssuesSonarRelease(json configData)(sql:ClientConnector){
   ...
   sql:ClientConnector sqlCon = create sql:ClientConnector(sql:MYSQL, dbHost, dbPort, dbName,dbUsername, dbPassword, {maximumPoolSize:maxPoolSize});
